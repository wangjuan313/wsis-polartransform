...
@torch.no_grad()
def visualize(epoch, model, data_loader, image_names, device, save_detection=None):
...
if __name__ == "__main__":
    ...
    if n_exp==1:
        ...
        experiment_name = 'residual_parallel_polarw_0.7_approx_focal_90_30_explogs=1_unary_pair_margin=5'
    ...
    for epoch in range(50):
        ...
        visualize(epoch, model, data_loader_test, image_names=image_names, device=device, save_detection=save_detection)
